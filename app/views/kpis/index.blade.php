...
<div class="x_panel">
     <div class="x_title">
           ...
           <div class="clearfix"></div>
					...
					<td> 
					<a class="btn btn-sm btn-warning" href="{{URL::to('kpis/edit/'.$item2->id)}}" ><i class="fa fa-pencil"></i>Edit</a>
					<a class="btn btn-sm btn-primary pull-right" href="{{URL::to('kpis/fields/'.$item2->id)}}" ><i class="fa fa-plus"></i>Fields</a>
					</td>
                    </tr>
                     @endforeach
                    @endforeach
