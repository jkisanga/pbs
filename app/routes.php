...
Route::group(array('before' => array('auth','supermanager')), function() {
	...
	Route::get('kpis/edit/{id}', 'KpisController@edit');
	Route::post('kpis/update/{id}', 'KpisController@update');
	...
	//Unit report per kpiEvaluation
	Route::get('kpiEvaluation/unitsKpireport', 'KpiEvaluationsController@getAllUnitKpiReport');
	Route::post('kpiEvaluation/unitsKpireport', 'KpiEvaluationsController@postAllUnitKpiReport');	

});

Route::group(array('before' => array('auth','manager','supermanager')), function() {
...
Route::group(array('before' => 'auth'), function() {
   ...
   //KPI staff links
	...
	Route::get('kpiEvaluation/edit/{id}', 'KpiEvaluationsController@edit');
	Route::post('kpiEvaluation/update/{id}', 'KpiEvaluationsController@update');
